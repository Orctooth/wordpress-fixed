...
* Fixed: All JavaScripts that the user added to the image caption, description and title will be filtered and, if the user has no rights, will be blocked. At the request of Vishnupriya Ilango of Fortinet's FortiGuard Labs.
