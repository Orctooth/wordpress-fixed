...
function ovation_blog_gettingstarted() {    	
	add_theme_page( esc_html__('Ovation Blog', 'ovation-blog'), esc_html__('Ovation Blog', 'ovation-blog'), 'edit_theme_options', 'ovation-blog-guide-page', 'ovation_blog_guide');   
}
...
define('OVATION_BLOG_LIVE_DEMO',__('https://www.ovationthemes.com/demos/ovation-blog-pro/','ovation-blog'));
define('OVATION_BLOG_BUY_PRO',__('https://www.ovationthemes.com/wordpress/blog-wordpress-theme/','ovation-blog'));
define('OVATION_BLOG_PRO_DOC',__('https://ovationthemes.com/docs/ot-blog-pro/','ovation-blog'));
...
function ovation_blog_guide() {
	...
	$theme = wp_get_theme( 'ovation-blog' ); ?>

	<div class="getting-started__header">
		<div class="col-md-10">
			<h2><?php esc_html_e( 'Ovation Blog', 'ovation-blog' ); ?></h2>
			<p><?php esc_html_e('Version: ', 'ovation-blog'); ?><?php echo esc_html($theme['Version']);?></p>
		</div>
		<div class="col-md-2">
			<div class="btn_box">
		...
		<div class="container">
			<div class="col-md-9">
				<div class="leftbox">
					...
					<p><?php esc_html_e('Go to dashboard >> Pages >> Add New Page >> Select "Custom Home Page" from page attribute >> Publish it.','ovation-blog'); ?></p>
			...
			<div class="col-md-3">
				<h3><?php esc_html_e('Premium Blog Theme','ovation-blog'); ?></h3>
				<img class="ovation_blog_img_responsive" style="width: 100%;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/screenshot.png">
				<div class="pro-links">
					<hr>
			    	<a class="button-primary" href="<?php echo esc_url( OVATION_BLOG_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'ovation-blog'); ?></a>
					<a class="button-primary" href="<?php echo esc_url( OVATION_BLOG_BUY_PRO ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'ovation-blog'); ?></a>
					<a class="button-primary" href="<?php echo esc_url( OVATION_BLOG_PRO_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'ovation-blog'); ?></a>
					<hr>
				</div>
